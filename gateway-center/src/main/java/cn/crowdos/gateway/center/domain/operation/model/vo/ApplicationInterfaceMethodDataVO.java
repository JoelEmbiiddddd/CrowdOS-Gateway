package cn.crowdos.gateway.center.domain.operation.model.vo;

/**
 * @File : ApplicationInterfaceMethodDataVO.py
...
public class ApplicationInterfaceMethodDataVO {
    ...
    /** 参数类型(RPC 限定单参数注册)；new String[]{"java.lang.String"}、new String[]{"cn.crowdos.gateway.rpc.dto.XReq"} */
