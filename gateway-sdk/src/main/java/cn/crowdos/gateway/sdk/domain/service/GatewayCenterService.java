package cn.crowdos.gateway.sdk.domain.service;

import cn.crowdos.gateway.sdk.GatewayException;
import cn.crowdos.gateway.sdk.common.Result;
...
public class GatewayCenterService {
    ...
    public void doRegisterApplicationInterfaceMethod(String address,
        ...
        String resultStr;
        try {
            resultStr = HttpUtil.post(address + "/wg/admin/register/registerApplicationInterfaceMethod", paramMap, 1550);
        } catch (Exception e) {
